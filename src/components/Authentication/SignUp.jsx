  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-12 sm:py-24 px-8">
      ...
      <div className="w-full flex flex-col items-center gap-5">
        <Link to="/account/login" className="!max-w-[360px] flex items-center justify-center text-sm w-full h-[70px] z-50 bg-white rounded-[19px] dark:bg-[#2E1F38]">
      ...
      <div className="w-full ">
        ...
        >
          ...
          <FormInput
            ...
            name="email"
            type="email"
            placeholder="یک ایمیل معتبر وارد نمایید"
            register={register}
            errors={errors}
          >
            <span>

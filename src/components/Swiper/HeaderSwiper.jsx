...
function HeaderSwiper() {
  ...
  return (
    <div className="">
      ...
      {error && (
        <div className="w-full min-h-full flex justify-center items-center pt-24 text-black/40 dark:text-white text-2xl font-bold">
          خطای بارگزاری اطلاعات
        </div>
      )}
      <Swiper
        effect={"fade"}
            ...
            <div className="relative h-full w-full">
              ...
              <div className="absolute top-10 right-10 space-y-6 text-white">
                ...
                <button className="bg-white rounded-xl px-4 py-2 hover:bg-opacity-90 transition">
                  <Link
                    to={`/post/${encodeURIComponent(slide.title)}`}
                    state={{ mal_id: slide.mal_id }}
                    className="text-[#451169] font-semibold"
                    href="#"
                  >
                    دانلود و پخش آنلاین
                  </Link>
